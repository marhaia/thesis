...
parser.add_argument('--model_val_path',default="saved_models/cog_high.pt", type=str)
...
def main():
    if args.validate:
        ...
        test_gt_dir = os.path.join(base_dir, "labels/labels_high/val/")
        test_fix_dir = os.path.join(base_dir, "fixs/fixs_high/val/")

        test_img_ids = [nm.split(".")[0] for nm in os.listdir(test_img_dir)]
