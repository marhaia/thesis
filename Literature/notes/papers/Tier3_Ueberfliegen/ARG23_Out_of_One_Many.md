...
> Note reicht fast immer. PDF nur wenn du Limitations aktiv schreibst.

**Direkt springen zu:**
- **Table 2 (S. 8-9):** Fidelity-Scores nach demografischer Gruppe
- **Figure 2 (S. 7):** Accuracy silicon vs. echte Befragung auf einen Blick
- **Section 4 Discussion (letzte 2 Seiten):** Was LLMs nicht replizieren koennen

**Ueberspringen:** Section 2-3 (Background + technische Implementierung), Appendix
