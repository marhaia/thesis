...
> Kurz reinschauen fuer Related Work Abgrenzung und als potenzielle Baseline.

**Direkt springen zu:**
- **Figure 2 (ca. S. 4):** UIClip-Architektur - zeigt auf einen Blick was das Modell macht
- **Table 1+2 (ca. S. 7-9):** Benchmark-Vergleiche gegen CLIP und LVLMs - dein Abgrenzungsargument
- **Section 5 Discussion + Limitations:** Was UIClip nicht kann (kein User-Modell, kein Task)

**Ueberspringen:** Section 3 (Dataset-Aufbau), technische Training-Details
